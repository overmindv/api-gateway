...
func Handler(users arcee.UserService, log *slog.Logger) http.Handler {
	server := handler.NewDefaultServer(generated.NewExecutableSchema(generated.Config{Resolvers: &Resolver{Users: users}}))
